...
train_dataset = CocoDetection(
    img_folder=f"data/dataset/",
    ann_file=f"data/dataset/train.json",
...
model_path = "configs/salience_detr/salience_detr_focalnet_large_lrf_800_1333.py"
...
resume_from_checkpoint = "checkpoints/salience_detr_focalnet_large_lrf_800_1333_coco_1x.pth"
